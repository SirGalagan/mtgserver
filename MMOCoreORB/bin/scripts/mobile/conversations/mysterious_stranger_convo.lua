...
start = ConvoScreen:new {
    id = "start",
    customDialogText = "You seek information and say words what should't be said out loud, but I know someone who can help.",
...
vantos_info = ConvoScreen:new {
    id = "vantos_info",
    customDialogText = "His name is Vantos. He lives on a remote island of Corellia. I can mark the location for you... or take you there.",
    stopConversation = "false",
    options = {
