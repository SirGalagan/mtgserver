...
includeFile("outfits/jedi_robe01_outfit.lua")
includeFile("outfits/jedi_robe04_outfit.lua")
includeFile("outfits/jedi_full_outfit.lua")
includeFile("outfits/clone_trooper_outfit.lua")
