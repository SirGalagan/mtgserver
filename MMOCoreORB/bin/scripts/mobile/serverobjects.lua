...
includeFile("imp_st_lvl15.lua")
includeFile("hangar_officer.lua")
includeFile("minirancor.lua")
includeFile("ahsoka.lua")
includeFile("helper.lua")
...
includeFile("imp_pilot_lvl15.lua")
includeFile("imp_officer_lvl15.lua")
includeFile("sith_dark_jedi.lua")
includeFile("lift_operator.lua")
-- New cities
