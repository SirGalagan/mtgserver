...
function fixer_convo_handler:bounty_hunter_track(pPlayer)

    print("bounty_hunter starts")
    local pGhost = CreatureObject(pPlayer):getPlayerObject()
    CreatureObject(pPlayer):sendSystemMessage(" \\#FFFF00\\You got a blaster and you think you already a bounty hunter,huh?")
    awardSkill(pPlayer, "outdoors_creaturehandler_master")
--[[
    -- Combat Medic
    awardSkill(pPlayer, "science_medic_master")
    awardSkill(pPlayer, "science_combatmedic_novice")
    -- Basic Creature Handler
    awardSkill(pPlayer, "outdoors_creaturehandler_novice")
    -- Bounty hunter
    awardSkill(pPlayer, "combat_marksman_master")
    awardSkill(pPlayer, "combat_bountyhunter_novice")
    local pInventory = SceneObject(pPlayer):getSlottedObject("inventory")
    if not pInventory or SceneObject(pInventory):isContainerFullRecursive() then
        CreatureObject(pPlayer):sendSystemMessage("Cant spawn items in Inventory")
    end
--[[
    -- Basic Bounty Hunter equipments
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_chest_plate.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_bicep_r.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_bracer_l.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_bracer_r.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_bicep_l.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_boots.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_helmet.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_belt.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_gloves.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/bounty_hunter/armor_bounty_hunter_leggings.iff", -1)
--[[
    -- Boba's weapons
    giveItem(pInventory, "object/weapon/ranged/carbine/carbine_ee3.iff", -1)
    giveItem(pInventory,"object/weapon/ranged/rifle/rifle_tenloss_dxr6_disruptor_loot.iff", -1)
    ...
    -- Mandalorian Armour
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_belt.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_bicep_l.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_bicep_r.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_bracer_l.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_bracer_r.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_chest_plate.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_gloves.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_helmet.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_leggings.iff", -1)
    giveItem(pInventory, "object/tangible/wearables/armor/mandalorian/armor_mandalorian_shoes.iff", -1)

    -- Some experience if needed
    -- CreatureObject(pPlayer):awardExperience("creaturehandler",200000,true)
    -- CreatureObject(pPlayer):awardExperience("",200000,true)
    ]]--


end -- bounty hunter fast track
